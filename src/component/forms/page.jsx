...
const EventList = () => {
    const events = [
        { id: 1, name: "Tech Conference 2023", date: "October 15, 2024", location: "kelkarcollege,Mumbai ,Maharastra" },
        { id: 2, name: "Music Festival", date: "November 20, 2024", location: "rizvi college, Mumbai,India" },
        { id: 3, name: "Indi-Go ", date: "December 5, 2024", location: "IIT BomBay,Mumbai,India" },
    ];
